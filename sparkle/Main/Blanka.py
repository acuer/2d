...
class Blanka:
    ...
    def SkillMove(self,frame_time):
        if( ( self.iState == STATE_SKILL_ORUGEN ) & (self.iStart > 6) ):
    ...
    def HitMove(self, frame_time):
        ...
        elif( (self.bHit == True ) & ( self.iHitDirX == DIR_LEFT ) & ( self.iHitState == STATE_SKILL_ORUGEN ) ):
        ...
        elif( (self.bHit == True ) & ( self.iHitDirX == DIR_RIGHT ) & ( self.iHitState == STATE_SKILL_ORUGEN ) ):
            self.iState = STATE_BLANKA_BURN_HIT
            if self.bHpCheck == False:
                self.iHpCX -= 10
                self.bHpCheck = True
