...
mygame = Target(
    script="Main.py",
    dest_base = "Sparkle",
    icon_resourcese=[(1, r"pico2d.ico")],
...
resources = "back.png Blanka_Left.png Blanka_Right.png Effect_Left.png Effect_Right.png Iori_Effect_Left.png iori_Effect_Right.png Iori_Orochi_Left.png Iori_Orochi_Right.png Mon_Hp.png Player_Effect_Left.png Player_Effect_Right.png Player_KillScore.png Player_Left.png Player_Right.png Stage_Field.png Stage_Field_BG.png Stage_Field_ReBG.png Status_BG.png Status_HpBar.png Status_SpBar.png title.png Countinue.wav DamageCry.wav DoorCrash.wav HeyComeon.wav IoriDie.wav IoriVoiceEnd.wav IoriVoiceL.wav JumpEnd.wav Kick(Effect).wav muran.mp3 PowerGeyser(Effect).wav PowerGeyser.wav Punch(Effect).wav Punch(HitEffect).wav".split()
